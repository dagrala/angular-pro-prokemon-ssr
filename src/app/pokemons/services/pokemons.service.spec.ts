...
const mockPokemon: Partial<Pokemon> = {
  id: 1,
  name: 'bulbasaur',
  // TODO: Otros campos de la interfaz Pokémon según sea necesario
};
...
describe('PokemonsService', () => {
  ...
  it('should load a Pokémon by ID', () => {
    const pokemonId = '1';
    service.loadPokemon(pokemonId).subscribe((pokemon: Partial<Pokemon>) => {
  ...
  it('should load a Pokémon by Name', () => {
    ...
    service.loadPokemon(pokemonName).subscribe((pokemon: Partial<Pokemon>) => {
      expect(pokemon).toEqual(mockPokemon);
    });
